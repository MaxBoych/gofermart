...
func (uc *UserUseCase) Register(ctx context.Context, req usermodels.UserRegisterRequest) (string, error) {
	...
	if err := uc.trManager.Do(ctx, func(ctx context.Context) error {
		...
		data = &usermodels.UserStorageData{Login: req.Login}
...
func (uc *UserUseCase) Login(ctx context.Context, req usermodels.UserLoginRequest) (string, error) {
	var tokenValue string
	if err := uc.trManager.Do(ctx, func(ctx context.Context) error {
...
func (uc *UserUseCase) generateNewToken(ctx context.Context, userID int64) (*tokenmodels.TokenStorageData, error) {
	...
	newToken := tokenmodels.TokenStorageData{
		UserID: userID,
		Value:  value,
	}
